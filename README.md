This is my **UNFINISHED** starting point for a simple [Love2D](https://www.love2d.org/) (version 11.5) game that uses game states and a CSV file for saving game data. 

I am puttering away at this, because I'd like to make an arcade style game to play on my [Anbernic RG 40XXV](https://retrocatalog.com/retro-handhelds/rg-40xxv) retro handheld, using [PortMaster](https://portmaster.games/) running in [Knulli](https://knulli.org/). I haven't tested this yet, but there are Love2D based games available through PortMaster, so it should run fine.
